...
# Deploys Jenkins with Python 3.11 and Azure CLI for ShodhAI CI/CD

set -e

# Configuration
RESOURCE_GROUP="shodhai-jenkins-rg"
LOCATION="eastus"
STORAGE_ACCOUNT="shodhaijenkins"
FILE_SHARE="jenkins-data"
ACR_NAME="shodhaijenkins"
CONTAINER_NAME="jenkins-shodhai"
DNS_NAME_LABEL="jenkins-shodhai-$(date +%s | tail -c 6)"
...
echo "╔════════════════════════════════════════════════════════╗"
echo "║  Deploying Jenkins for ShodhAI                       ║"
echo "╚════════════════════════════════════════════════════════╝"
echo ""
