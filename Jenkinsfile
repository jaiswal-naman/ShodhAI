pipeline {
    ...
    environment {
        ...
        // App config
        APP_RESOURCE_GROUP = 'shodhai-app-rg'
        APP_NAME = 'shodhai-app'
        ACR_NAME = 'shodhairegistry'
        IMAGE_NAME = 'shodhai-app'
        CONTAINER_ENV = 'shodhai-env'
    }
            ...
            steps {
                script {
                    ...
                    checkout([
                        $class: 'GitSCM',
                        branches: [[name: '*/main']],
                        userRemoteConfigs: [[url: 'https://github.com/jaiswal-naman/ShodhAI.git']]
                    ])
                }
            }
        }
